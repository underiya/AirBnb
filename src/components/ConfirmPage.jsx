...
export default function ConfirmPage() {
  ...
  return (
    <div className='mx-auto w-10/12'> 
        ...
        <h3 >Share why you're travelling, who's coming with you and what you love about the space.</h3>
        <div className='flex justify-between mr-4 mt-2'>
          <h2>Permanent Account Number (PAN)</h2>
          {/* <button className='rounded-lg border-black border-2 px-2 '>Add</button> */}
          <PANModal/>
        </div>
        <h3 >A valid PAN is required per Reserve Bank of India (RBI) regulations.</h3>
        <div className='flex justify-between mr-4 mt-2'>
          <h2>Phone number</h2>
         <PhoneNumberModal/>
        </div>
        ...
        <hr className='mt-3'/>
        <p className='mt-3 text-xs'>By selecting the button below, I agree to the <strong> Host's House Rules, Ground rules for guests, Airbnb's Rebooking and Refund Policy </strong> and that Airbnb can <strong>charge my payment method </strong>  if I’m responsible for damage.</p>
        {/* <button className='mt-3 p-3  bg-pink-600 text-white rounded-lg mb-4'>Confirm and Pay</button> */}
  
        <ConfirmPay/>
        </div>
        <div className='w-2/6 h-auto  shadow-lg rounded-xl border-1 border-gray-100  absolute top-40 right-36'>
        <div >
          <HotelCard/>
        </div>
         </div>
