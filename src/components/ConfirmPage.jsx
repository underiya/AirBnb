...
function ConfirmPage() {
  return (
    <div className='mx-auto w-10/12'>
        ...
        <div className='mt-9 w-6/12  bg-red-400'>
        <div className='red'>
          <div >
        ...
        <div className=''>
          <h1 className='font-medium'>Your trip</h1>
          <div className='flex justify-between '>
            <div className='mt-3'>
            <h2 >Dates</h2>
            <h2>4-9 Mar</h2>
            </div>
          <button className='mr-9'>Edit</button>
          </div>
          <div>
       ...
       <div className=' h-15 w-full border border-black-600 p-5'>
        <select name="selectedFruit">
        <option value="apple">UPI </option> 
        <option value="banana">Credit or debit card <i class="fa-solid fa-check"></i></option>
        <option value="orange">Net Banking <i class="fa-solid fa-check"></i></option>
      </select>
      </div>
        ...
        <h3>Cancel before 26 Feb for a partial refund. After that, the reservation is non-refundable</h3>
        <span>Learn more</span>
        <hr />
        <h1>Ground rules</h1>
        <h2>We ask every guest to remember a few simple things about what makes a great guest.</h2>
        <ul>
          <li>Follow the house rules</li>
          <li>Treat your Host’s home like your own</li>
        </ul>
        <hr />
        <p>By selecting the button below, I agree to the <strong> Host's House Rules, Ground rules for guests, Airbnb's Rebooking and Refund Policy </strong> and that Airbnb can <strong>charge my payment method </strong>  if I’m responsible for damage.</p>
        <button>Confirm and Pay</button>
        </div>
        <div className='w-2/6 h-4/6  shadow-lg rounded-xl border-1 border-gray-100  absolute top-16 right-36'>
        <div className='pink'>
          <div >
            <img src="" alt="" />
            <h1>Noble room into the ...</h1>
            <p>Room in...</p>
            <h3>4.88 <span>(173)</span></h3>
          </div>
          <hr />
          <h1>Price details</h1>
          <div>
            <h3>₹3,764.9 x 5 nights</h3>
            <h3>₹18,824.5</h3>
          </div>
          <div>
            <h3>Cleaning fee</h3>
