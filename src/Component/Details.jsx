...
<h1 className='font-bold text-2xl text-start'>{detailData.location}</h1>       
            ...
            <span> <p><box-icon className="mr-2 h-2 w-2 mt-6" type='solid' name='star'></box-icon>{detailData.rating}</p> <p>{detailData.review}</p></span>
